...
summary_table = build_summary_table(results, farm_spacings, wave_cases, wavelengths);
...
function T = build_summary_table(results, farm_spacings, wave_cases, wavelengths)
rows = {};
